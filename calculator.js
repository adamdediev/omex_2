...
leaseTermSlider.addEventListener("input", () => {
  leaseTermValue.innerHTML = `${Number(leaseTermSlider.value)} мес.`;
...
// Получаем элемент для закрытия окна
var closeBtn = document.querySelector(".close");

// Обработчик события для открытия окна
...
// Обработчик события для закрытия окна при клике на фон
